...
class Application:
    def __init__(self, master):
        ...
        self.name = Label(self.left, text='Patient name', font=('arial 18 bold'), fg='black', bg='lightgreen')
        ...
        self.time = Label(self.left, text='Phone Number', font=('arial 18 bold'), fg='black', bg='lightgreen')
